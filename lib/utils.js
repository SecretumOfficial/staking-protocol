...
function calculateReward(apyMax, poolStaked, poolReward, timeFrameStart, timeFrameEnd, staked, stakeStartTime, minStakePeriod = 0)
{
    if (staked === 0 || stakeStartTime >= timeFrameEnd){
        return 0;
    }
    let seconds = timeFrameEnd - timeFrameStart;
    if (stakeStartTime > timeFrameStart) {
        seconds = timeFrameEnd - stakeStartTime;
    }
